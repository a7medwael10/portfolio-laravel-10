...
<template>
    <section id="home" class="portfolio-section flex min-h-[calc(100vh-theme(spacing.nav))] items-center py-10 md:py-14">
        <div class="grid w-full items-center gap-10 lg:grid-cols-12 lg:gap-12">
            ...
            <div class="order-1 space-y-6 lg:col-span-7 lg:space-y-7">
                ...
                <div class="space-y-3">
                    <p class="text-xs font-semibold uppercase tracking-[0.18em] text-content-muted">
                        Hello, I’m
                    </p>
                    <h1 class="text-4xl font-bold tracking-tight text-content sm:text-5xl lg:text-[3.25rem] lg:leading-tight">
                ...
                <p class="max-w-xl text-base leading-relaxed text-content-secondary sm:text-lg">
            ...
            <div class="order-2 lg:col-span-5">
                <div class="relative mx-auto max-w-sm lg:ml-auto lg:mr-0 lg:max-w-none">
                    <div
                    ...
                    >
                        <div class="aspect-[4/5] overflow-hidden bg-surface-elevated">
                            <img
                            ...
                            >
                                <span class="text-sm tracking-wide">Portrait coming soon</span>
                            </div>
                        </div>
                    </div>
                </div>
